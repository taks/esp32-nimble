...
pub fn return_code_to_string(rc: i32) -> Option<&'static str> {
  match rc as u32 {
    ...
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_HW_FAIL) => Some("Hardware Failure"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_PAGE_TMO) => Some("Page Timeout"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_AUTH_FAIL) => Some("Authentication Failure"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_PINKEY_MISSING) => Some("PIN or Key Missing"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_MEM_CAPACITY) => Some("Memory Capacity Exceeded"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_CONN_SPVN_TMO) => Some("Connection Timeout"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_CONN_LIMIT) => Some("Connection Limit Exceeded"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_SYNCH_CONN_LIMIT) => Some("Synchronous Connection Limit To A Device Exceeded"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_ACL_CONN_EXISTS) => Some("ACL Connection Already Exists"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_CMD_DISALLOWED) => Some("Command Disallowed"),
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_CONN_REJ_RESOURCES) => Some("Connection Rejected due to Limited Resources"),
    ...
    HCI_ERR!(sys::ble_error_codes_BLE_ERR_CONN_TERM_MIC) => Some("Connection Terminated; MIC Failure"),
